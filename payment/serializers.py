...
from accounts.serializers import BillingAddressSerializer, ShippingAddressSerializer
...
class PaymentSerializer(serializers.ModelSerializer):
    ...
    buyer = serializers.CharField(source="order.buyer.username", read_only=True)
